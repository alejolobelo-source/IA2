...
print("--- TALLER 1: ---")  # [Bloque 0: Salida] - Muestra en la terminal el encabezado de la sección 1
...
print("\n--- ENTREGA FINAL ---")  # [Bloque 4: Salida] - Imprime cabecera de la sección de convolución
